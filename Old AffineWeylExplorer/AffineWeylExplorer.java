    ...
    void rebuildInputs() {
        ...
        if ("A1xA1".equals(gkey)) {
            if (!isCocon) {
                ...
                inputsPanel.add(label("2nd \u00c3\u2081 component  (digit form only)", 9, Font.PLAIN, MUTED));
                fields[1] = addField(inputsPanel, "e.g.  01  or  t_(2,0)*(s_1,e)");
            } else {
                inputsPanel.add(label("Element 1  \u2014  1st \u00c3\u2081", 9, Font.PLAIN, MUTED));
                fields[0] = addField(inputsPanel, "e.g.  01  or  t_(2,0)*(s_1,e)");
                inputsPanel.add(label("Element 1  \u2014  2nd \u00c3\u2081  (digit form only)", 9, Font.PLAIN, MUTED));
                fields[1] = addField(inputsPanel, "e.g.  01  or  t_(2,0)*(s_1,e)");
                ...
                inputsPanel.add(label("Element 2  \u2014  2nd \u00c3\u2081  (digit form only)", 9, Font.PLAIN, MUTED));

╔══════════════════════════════════════════════════════════════╗
║       Affine Weyl Group Explorer  —  README                  ║
╚══════════════════════════════════════════════════════════════╝


WHAT IS THIS?
─────────────
A desktop application for computing and visualizing:
  • Conjugacy classes
  • Coconjugation sets

in affine Weyl groups of ranks 2 and 3:

  Rank 2 (2D plots):   A1xA1,  A2-tilde,  B2-tilde,  C2-tilde,  G2-tilde
  Rank 3 (3D plots):   A3-tilde,  B3-tilde,  C3-tilde


FILES
─────
  AffineWeylExplorer.java     The application
...
The window has a control panel on the left and a plot area on the right.
  ...
  1  Select group       8 affine Weyl groups (ranks 2 and 3)
  ...
  4  Bounding box       Slider — controls how many alcoves are shown
                        Keep at 3-5 for rank-3 groups (A3, B3, C3)
  ...
  Rank-2 results        2D image shown directly in the window
  Rank-3 results        3D interactive viewer opens in your browser
...
───────────────
  ...
  * Striped alcove:                    indicates the element is
...
Computation is slow
  Lower the bounding box. Rank-3 groups with bbox > 5

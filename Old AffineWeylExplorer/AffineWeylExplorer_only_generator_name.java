// AffineWeylExplorer.java
// Requires Java 11+  (run with:  java AffineWeylExplorer.java)
...
public class AffineWeylExplorer extends JFrame {
    ...
    static final Object[][] EXAMPLES = {
        {"\u00c3\u2081\u00d7\u00c3\u2081  conj (01,010)", "A1xA1","conj","01","010","","",10},
        {"\u00c3\u2081\u00d7\u00c3\u2081  cocon",          "A1xA1","cocon","01","01","10","01",10},
        {"\u00c3\u2082  conj  s_010",                         "aff2_A","conj","010","","","",10},
        {"\u00c3\u2082  cocon",                               "aff2_A","cocon","01021","0210210201020","","",5},
        {"C\u0303\u2082  conj  s_12012101",                   "aff2_C","conj","12012101","","","",7},
        {"C\u0303\u2082  cocon",                              "aff2_C","cocon","12012101","212101210121","","",7},
        {"B\u0303\u2082  conj  s_0",                          "aff2_B","conj","0","","","",7},
        {"G\u0303\u2082  conj  s_02121",                      "aff2_G","conj","02121","","","",7},
        {"G\u0303\u2082  cocon",                              "aff2_G","cocon","02121","212102121","","",7},
        {"\u00c3\u2083  conj  s_13",                          "A3","conj","13","","","",3},
        {"\u00c3\u2083  cocon  s_13/s_1210\u2026",           "A3","cocon","13","1210301201","","",5},
        {"B\u0303\u2083  conj  s_1",                          "B3","conj","1","","","",3},
        {"B\u0303\u2083  cocon  s_1 / s_1",                   "B3","cocon","1","1","","",3},
        {"C\u0303\u2083  conj  s_13",                         "C3","conj","13","","","",3},
        {"C\u0303\u2083  cocon  s_13 / s_13",                 "C3","cocon","13","13","","",3},
    };
    ...
    // CONSTRUCTOR
    // ════════════════════════════════════════════════════════════════════
    public AffineWeylExplorer() {
        super("  Affine Weyl Group Explorer");
    ...
    void locateHelper() {
        ...
        String here = AffineWeylExplorer.class.getProtectionDomain()
        ...
        if (!helperSage.exists()) {
            JOptionPane.showMessageDialog(this,
                "compute_helper.sage not found.\nPlease keep it in the same folder as AffineWeylExplorer.java.",
    ...
    void buildUI() {
        ...
        JLabel title = label("Affine Weyl Group Explorer", 14, Font.BOLD, TEXT);
    ...
    void rebuildInputs() {
        ...
        if ("A1xA1".equals(gkey)) {
            if (!isCocon) {
                inputsPanel.add(label("1st \u00c3\u2081 component", 9, Font.PLAIN, MUTED));
                fields[0] = addField(inputsPanel, "e.g.  01");
                inputsPanel.add(label("2nd \u00c3\u2081 component", 9, Font.PLAIN, MUTED));
                fields[1] = addField(inputsPanel, "e.g.  010");
            } else {
                inputsPanel.add(label("Element 1  \u2014  1st \u00c3\u2081", 9, Font.PLAIN, MUTED));
                fields[0] = addField(inputsPanel, "e.g.  01");
                inputsPanel.add(label("Element 1  \u2014  2nd \u00c3\u2081", 9, Font.PLAIN, MUTED));
                fields[1] = addField(inputsPanel, "e.g.  01");
                inputsPanel.add(vgap(6));
                inputsPanel.add(label("Element 2  \u2014  1st \u00c3\u2081", 9, Font.PLAIN, MUTED));
                fields[2] = addField(inputsPanel, "e.g.  10");
                inputsPanel.add(label("Element 2  \u2014  2nd \u00c3\u2081", 9, Font.PLAIN, MUTED));
                fields[3] = addField(inputsPanel, "e.g.  01");
            }
        } else {
            if (!isCocon) {
                inputsPanel.add(label("Element", 9, Font.PLAIN, MUTED));
                fields[0] = addField(inputsPanel, gkeyVal.startsWith("aff2_") ? "e.g.  12" : "e.g.  13");
            } else {
                String ph1 = gkeyVal.startsWith("aff2_") ? "e.g.  12" : "e.g.  13";
                String ph2 = gkeyVal.startsWith("aff2_") ? "e.g.  21" : "e.g.  1210301201";
        ...
        inputsPanel.add(vgap(4));
        inputsPanel.add(label("Digit strings only  \u2014  leave blank for identity e",
                               9, Font.PLAIN, MUTED));
    ...
    void doCompute() {
        ...
        for (String v : inputs) {
            if (!v.isEmpty() && !v.matches("[0-9]+")) {
                setStatus("\u2717  Input error: \""+v+"\" must be digits only.", ERR);
                return;
            }
        }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            new AffineWeylExplorer().setVisible(true);
        });
    }
}